...
type HeatmapDataSets = {
  ...
  interval: any;
  xFormatter?: any["xAxisLabelFormatter"];
};
...
export const DATA_1: HeatmapDataSets = {
  ...
  xFormatter: (value: string | number) => {
    return DateTime.fromMillis(value as number).toFormat("dd/MM HHa", {
...
export const DATA_2: HeatmapDataSets = {
  ...
  xFormatter: (value: string | number) => {
    return DateTime.fromMillis(value as number).toFormat("dd MMM HHa", {
      timeZone: "Europe/Rome",
    });
  },
  timeZone: "Europe/Rome",
...
export const DATA_3: HeatmapDataSets = {
  interval: { type: "fixed", unit: "h", value: 12 },
  xFormatter: (value: string | number) => {
    return DateTime.fromMillis(value as number).toFormat("HH:mm", {
      timeZone: "Europe/Rome",
    });
  },
  timeZone: "Europe/Rome",
...
export const DATA_4: HeatmapDataSets = {
  ...
  xFormatter: (value: string | number) => {
    return DateTime.fromMillis(value as number).toFormat("dd/MM HH:mm", {
      timeZone: "Europe/Rome",
    });
  },
  timeZone: "Europe/Rome",
...
export const DATA_9: HeatmapDataSets = {
  ...
  domain: {
    min: 1616799600000 - 5 * 60 * 60 * 1000,
    max: 1617055200000 + 6 * 60 * 60 * 1000,
  },
  interval: { type: "fixed", unit: "m", value: 60 },
  xFormatter: (value: string | number) => {
    return DateTime.fromMillis(value as number).toFormat("HH:mm", {
