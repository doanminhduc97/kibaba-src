...
export default class TableSearch extends Component {
  ...
  toggleOpenOnMobile = () => {
    this.setState({
      isSideNavOpenOnMobile: !this.isSideNavOpenOnMobile,
    });
  };
  ...
  createItem = (name, data = {}) => {
    ...
    return {
      id: name,
      name,
      isSelected: this.selectedItemName === name,
    ...
    this.createItem("Kibana", {
      ...
      items: [
        this.createItem("Advanced settings", {
          items: [
            this.createItem("General", { disabled: true }),
    ...
    return (
      ...
      >
        ...
        <EuiPageBody>
          <EuiPageBody>
            <EuiPageHeader
            // rightSideItems="<button>test</button>"
            />
            <EuiPageContent hasShadow={false} color="transparent">
              <EuiPageContentBody>
                <div>
